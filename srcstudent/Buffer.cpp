		...
		const AmbientLight & ambientLight, const PointLight & pointLight)
{
    ...
    for(int compteur = scanLineComputer.ymin ; compteur <= scanLineComputer.ymax ; compteur++)
    {
        ...
        q1 = posi1*scanLineComputer.leftweight.data[compteur].data[0]+posi2*scanLineComputer.leftweight.data[compteur].data[1]+posi3*scanLineComputer.leftweight.data[compteur].data[2];
        q2 = posi1*scanLineComputer.rightweight.data[compteur].data[0]+posi2*scanLineComputer.rightweight.data[compteur].data[1]+posi3*scanLineComputer.rightweight.data[compteur].data[2];

        n1 = normal1*scanLineComputer.leftweight.data[compteur].data[0]+normal2*scanLineComputer.leftweight.data[compteur].data[1]+normal3*scanLineComputer.leftweight.data[compteur].data[2];
        n2 = normal1*scanLineComputer.rightweight.data[compteur].data[0]+normal2*scanLineComputer.rightweight.data[compteur].data[1]+normal3*scanLineComputer.rightweight.data[compteur].data[2];
